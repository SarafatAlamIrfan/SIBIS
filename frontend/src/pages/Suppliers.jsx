  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-96 space-y-4">
        ...
        <p className="text-slate-400 dark:text-slate-555 font-semibold text-xs tracking-wider animate-pulse">SOURCING VENDORS...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-[pulse-subtle_2s_ease-out_1]">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-slate-850 dark:text-white">Supplier Management</h1>
