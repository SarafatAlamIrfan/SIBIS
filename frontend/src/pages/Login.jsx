  ...
  const rolesList = [
    {
      name: 'Site Admin',
      icon: Shield,
      color: 'hover:border-purple-500/40 text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/10 border-slate-200 dark:border-slate-800',
    ...
    },
    {
      name: 'Owner',
      icon: Store,
      color: 'hover:border-red-500/40 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/10 border-slate-200 dark:border-slate-800',
    ...
    },
    {
      name: 'Manager',
      icon: UserCheck,
      color: 'hover:border-blue-500/40 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/10 border-slate-200 dark:border-slate-800',
    ...
    },
    {
      name: 'Cashier',
      icon: CreditCard,
      color: 'hover:border-green-500/40 text-emerald-600 dark:text-green-400 bg-emerald-50 dark:bg-emerald-950/10 border-slate-200 dark:border-slate-800',
      activeColor: 'border-green-500 ring-2 ring-green-500/25 bg-emerald-100 dark:bg-emerald-950/30 text-emerald-600 dark:text-green-400',
      desc: 'POS Sales transactions and cashier desk.',
    },
    {
      name: 'Inventory Staff',
      icon: Package,
      color: 'hover:border-amber-500/40 text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/10 border-slate-200 dark:border-slate-800',
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3.5 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white bg-slate-50/50 dark:bg-slate-950 placeholder-slate-400 dark:placeholder-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-xs transition-all font-semibold"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-350 transition-colors cursor-pointer"
